...
fa_years = ["2021", "2021-2022", "2021-2023", "2021-2024"]
...
Team.create(name: "Phillies", logo: "/images/phillies.png", total_salary: rand(85.0..150).round(1), playoff_discount: 0.0, user_id: 21)
...
Player.create(name: "Bryan Holaday" , position: "C", years: 0, salary_per_year: 0, real_mlb_team: "Arizona Diamondbacks", minor_league_status: false, team_control: "Free Agent", team_id: 31)
Player.create(name: "Dominic Miroglio" , position: "C", years: 0, salary_per_year: 0, real_mlb_team: "Arizona Diamondbacks", minor_league_status: false, team_control: "Free Agent", team_id: 31)
Player.create(name: "Jose Urena" , position: "SP", years: 0, salary_per_year: 0, real_mlb_team: "Detroit Tigers", minor_league_status: false, team_control: "Free Agent", team_id: 31)
Player.create(name: "Nick Margevicius" , position: "RP", years: 0, salary_per_year: 0, real_mlb_team: "Seattle Mariners", minor_league_status: false, team_control: "Free Agent", team_id: 31)
...
Bid.create(years: 1, salary_per_year: 0.5, player_id: 501, user_id: 1)
Bid.create(years: 1, salary_per_year: 0.6, player_id: 501, user_id: 2)
Bid.create(years: 1, salary_per_year: 0.8, player_id: 501, user_id: 3)
Bid.create(years: 1, salary_per_year: 1.6, player_id: 501, user_id: 4)
Bid.create(years: 2, salary_per_year: 2.0, player_id: 502, user_id: 5)
Bid.create(years: 2, salary_per_year: 2.5, player_id: 502, user_id: 6)
Bid.create(years: 3, salary_per_year: 3.0, player_id: 503, user_id: 1)
Bid.create(years: 4, salary_per_year: 4.0, player_id: 503, user_id: 4)
Bid.create(years: 2, salary_per_year: 2.5, player_id: 504, user_id: 4)
Bid.create(years: 1, salary_per_year: 3.0, player_id: 504, user_id: 25)
Bid.create(years: 1, salary_per_year: 4.0, player_id: 505, user_id: 4)
Bid.create(years: 1, salary_per_year: 4.5, player_id: 505, user_id: 7)
Bid.create(years: 1, salary_per_year: 21.0, player_id: 506, user_id: 4)
Bid.create(years: 1, salary_per_year: 22.0, player_id: 506, user_id: 1)
Bid.create(years: 1, salary_per_year: 8.0, player_id: 507, user_id: 7)
